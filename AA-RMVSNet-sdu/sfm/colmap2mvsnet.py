...
if __name__ == '__main__':
    ...
    parser.add_argument('--convert_format', action='store_true', default=True, help='If set, convert image to jpg format.')

    args = parser.parse_args()

    image_dir = os.path.join(args.dense_folder, 'original_images')
