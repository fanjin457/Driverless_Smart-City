...
if __name__ == '__main__':
    ...
    net.load_state_dict(torch.load('./seg/checkpoints/0726/checkpoint_epoch28.pth', map_location=device))
    ...
    for i in range(10):  # 10次循环
    # Nonetype
    # Numpy数组报错 coutours findpath  车要走到边缘了或模型训练的不太好，没路了
    # urlopen  网络连接不上，看摄像头串口监视器
